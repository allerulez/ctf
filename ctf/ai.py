...
# usefull for developing new Ais
#
class Ai:
  #
  ...
  def has_object_in_direction(self, max_distance, direction):
    return self.query_objects_in_direction(max_distance, direction) != None
  #
  ...
  def has_object_in_absolute_direction(self, max_distance, direction):
    return self.query_objects_in_absolute_direction(max_distance, direction) != None
  #
